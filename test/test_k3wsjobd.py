...
class TestWsjobd(unittest.TestCase):
    ...
    def test_invalid_jobdesc(self):
        cases = (
            ...
            (k3utfjson.dump({"ident": "foo", "func": "foo", "jobs_dir": {}}), "invalid jobs_dir"),
        )
    ...
    def test_invalid_check_load_args(self):
        cases = (
            {"check_load": {"mem_low_threshold": "foo", "cpu_low_threshold": 0}},
            {"check_load": {"cpu_low_threshold": None, "mem_low_threshold": 0}},
            {"check_load": {"max_client_number": {}, "cpu_low_threshold": 0, "mem_low_threshold": 0}},
        )
